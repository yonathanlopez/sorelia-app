...
export default function Home() {
  ...
  return (
    <div className="min-h-screen pb-28 hide-scrollbar bg-gray-100">
      ...
      {/* Stats Bar */}
      <div className="bg-white rounded-2xl shadow-sm flex items-center justify-around divide-x divide-gray-200/50 px-3 py-3.5 mx-4 my-3">
        <div className="flex flex-col items-center gap-2.5 flex-1">
          ...
          <span className="text-2xl font-extrabold text-gray-900">{totalGoals}</span>
        </div>
        <div className="flex flex-col items-center gap-2.5 flex-1">
          ...
          <span className="text-2xl font-extrabold text-gray-900">{completedGoals}</span>
        </div>
        <div className="flex flex-col items-center gap-2.5 flex-1">
          ...
          <span className="text-2xl font-extrabold text-gray-900">{upcomingCal.length}</span>
        </div>
      </div>
         ...
         <div className="flex items-center justify-between px-4 py-3 border-b border-gray-50">
          ...
          <div className="divide-y divide-gray-50">
            ...
            <div className="px-4 py-8 text-center">
                ...
                <p className="text-xs text-gray-300 mt-0.5">No tasks for today</p>
              </div> :
            ...
            <div key={task.id} className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 transition-colors">
                ...
                'border border-gray-300 text-gray-400 hover:border-emerald-500 hover:text-emerald-500'}`
                }>
                
                    {completedToday.has(task.id) && <Check className="w-3.5 h-3.5" />}
                  </button>
                </div>
            )
            }
