  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="px-2 py-2 rounded">
        <button           className="w-full bg-white rounded-xl border border-gray-100 shadow-sm text-left hover:shadow-md transition-all text-sm">
      ...
      <div className="flex flex-col gap-2 px-2 py-2 pb-28">
        ...
        <button
          ...
          className="w-full bg-white rounded-xl border border-gray-100 shadow-sm text-left hover:shadow-md transition-all">
